...
/**
 * printError - prints an error for message
 *
 ...
 * @fd: filedescriptor
 *
 * Return: decimal integers printed
 *
 */
...
/**
 * removeComments - function that replaces first instance of '#'
 * with '\0'
 *
