...
/**
 * isChain - test if current character is chain
 * delimeter
 *
...
/**
 * checkChain - checks wheteher we should continue chaining based
 * on the last status
 *
 * @info: parameter struct
 *
...
/**
 * replaceAlias - replaces aliases in the tokenized
 * string
 *
 * @info: parameter struct
 *
